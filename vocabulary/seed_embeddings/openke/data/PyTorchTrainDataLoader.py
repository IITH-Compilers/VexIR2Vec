...
class PyTorchTrainDataset(Dataset):
    ...
    def setSamplingMode(self, sampling_mode):
        self.sampling_mode = sampling_mode
    ...
    def setBernFlag(self, bern_flag):
        self.bern_flag = bern_flag

    def setFilterFlag(self, filter_flag):
        self.filter_flag = filter_flag
...
class PyTorchTrainDataLoader(DataLoader):
    def __init__(
        ...
        if batch_size == None:
            self.batch_size = dataset.getTriTot() // nbatches
        if nbatches == None:
            self.nbatches = dataset.getTriTot() // batch_size
    ...
    def setSamplingMode(self, sampling_mode):
        self.dataset.setSamplingMode(sampling_mode)
    ...
    def setEntNegRate(self, rate):
        self.dataset.setEntNegRate(rate)

    def setRelNegRate(self, rate):
        self.dataset.setRelNegRate(rate)

    def setBernFlag(self, bern_flag):
        self.dataset.setBernFlag(bern_flag)

    def setFilterFlag(self, filter_flag):
        self.dataset.setFilterFlag(filter_flag)
    ...
    def getEntTot(self):
        return self.dataset.getEntTot()

    def getRelTot(self):
        return self.dataset.getRelTot()

    def getTripleTot(self):
        return self.dataset.getTriTot()
