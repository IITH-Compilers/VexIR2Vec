...
class NegativeSampling(Strategy):
    def __init__(
        self, model=None, loss=None, batch_size=256, regul_rate=0.0, l3_regul_rate=0.0
    ):
    ...
    def forward(self, data):
        ...
        p_score = self.GetPositiveScore(score)
        n_score = self.GetNegativeScore(score)
